...
#### Adding Hypervisor environments to Move


1\. From edge browser favourite bar click on "Nutanix Move"
...
3\. Click the "Select Environment Type" field.
...
5\. Click the "Environment Name" field and enter desired name.
...
6\. Click the "vCenter Server, standalone ESXi host, or VMC on AWS" field. and enter "192.168.1.3" or "vcenter01.demo.local"
...
7\. Click the "User Name" field and enter "admin@vsphere.local"
...
8\. Click the "Password" field and enter "Password123!"
...
10\. Now to add a Nutanix Environment: Click "Add Environment"
...
11\. Click the "Select Environment Type" field.
...
12\. Click "Nutanix AOS" and enter desired name.
...
13\. Click the "Nutanix Environment" field and enter Nutanix Prism IP "192.168.1.110"or"nutanixcluster1.demo.local"
...
14\. Click the "User Name" field and enter "admin".
...
15\. Click the "Password" field and enter "Pas$word123!"
...
16\. Click "Show" to verify password.
...
17\. Click "Add". PLease wait a few moments as move will require to inventory the environments.
...
18\. Click "Create a Migration Plan"
...
19\. Click the "Plan Name" field and provide a desired Migration plan name.
...
21\. Click the "Select a Source" field.
...
23\. Click the "Select a Target" field.
...
25\. Click the "Target Container" field.
...
26\. Click "default-container-92178684508689"
...
28\. Click this button to flag Win2022-VM1 for migration
...
29\. Click this button to flag Win2022-VM2 for migration
...
31\. Click the "Select a Target Network" field.
...
34\. Click the "User Name" field and enter "administrator".
...
35\. Click the "Password" field and enter "Password123!"
...
36\. Click "Show" to verify the password.
...
38\. Leave all defaults and Click "Next"
...
#### Starting and Monitoring the Migration Plan.


41\. Click "In Progress" once it appears.
...
42\. Click the ? icon to get detailed information on the progress per VM.
...
43\. In Edge Switch to tab vCenter to verify move is communicating with vCenter


44\. Click anywhere in the taskarea and validate that vCenter is receiving commands from move.
...
45\. Switch back to tab in edge "Move"


46\. Continue to monitor the move progress by clicking the ? icon.
...
48\. Monitor the migration progress. Approx 10 to 15 Minutes.
...
49\. Once the migration has completed you will notice the Migration status as "Ready to Cutover"  Select both VMs.
...
#### Complete Cutover from ESXi to Nutanix
...
53\. Switch Tabs in Edge to vCenter
...
55\. Move will "Initiate guest OS shutdown" on both VMs to complete the migration to Nutanix AHV
...
56\. Switch Edge tab to "Move"


57\. Continue monitoring the migration by clicking ?.
...
58\. Switch to tab Nutanix Prism UI by clicking "Prism Element  tab.


59\. Click the "username" field and type "admin".
...
60\. Click in the password field and enter "Pas$word123!"
...
62\. Click "VM" and watch as the VMs are created on the Nutanix VM page
...
65\. Click "Launch Console" to view the VM coming up on the Nutanix Side
...
66\. Switch to tab Move"


67\. Click on X to review the Migration status
...
68\. After the VMs have come up on the nutanix side and clean up has been performed  the status will change to "Complete"
